...
# create working folders
mkdir -vp ${ROOT_DIR}/hosts
# download
./download.sh ${BOOTSTRAP_STORAGE_ACCOUNT_NAME} ${BOOTSTRAP_STORAGE_ACCOUNT_KEY} bootstrap hosts.tar.gz ${ROOT_DIR}/hosts/hosts.tar.gz
# change dir to hosts
pushd ${ROOT_DIR}/hosts
# untar file
tar -xzvf hosts.tar.gz
# clean up
rm -rf hosts.tar.gz
# set permissions for all scripts
chmod +x ${ROOT_DIR}/hosts/*.sh
# restore dir
popd
